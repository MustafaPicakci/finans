...
function systemPrompt(ctx: UserContext): string {
  return [
    ...
    "- Araç 'uyari' döndürürse ONU KULLANICIYA AKTAR (kısaca). Özellikle iki tanesi rakamın anlamını",
    "  değiştirir: kart harcamalarının kategorisi olmadığı ve ekstre ödemelerinin toplam dışında",
    "  kaldığı. Bunları saklamak, kullanıcının yanlış rakama güvenmesi demektir.",
