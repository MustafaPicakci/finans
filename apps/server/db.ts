...
export const TENANT_TABLES = [
  "accounts", "recurring", "loans", "oneoffs", "trades", "cards", "card_txs", "categories", "transactions", "deposits", "recurring_realized", "statement_payments", "recurring_amounts", "portfolios", "account_entries",
] as const;
