...
/**
 * Türkçe tutar biçimini ayrıştırır: "1.234,56" → 1234.56. Nokta yalnızca 3'lü basamak
 * gruplarının hemen ardından bir rakam-olmayan karakter ya da sonu geldiğinde binlik
 * ayracı sayılıp silinir (böylece "1234.56" gibi düz ondalık girişler bozulmaz);
 * virgül her zaman ondalık ayracıdır.
 */
